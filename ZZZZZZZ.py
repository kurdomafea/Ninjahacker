...
B ='\033[1;92m'
A ='\033[1;91m'
re = requests.get("https://pastebin.com/raw/hCyq7vTF")
p = input(B+"[✓] code your member :")
if p == " HERO " :
  sys.exit()
if p in str(re.text):
  print("you Are Active HERO")
else:
  print(B+"password error came HerO @H8PPP")
  sys.exit()
os.system("clear")
